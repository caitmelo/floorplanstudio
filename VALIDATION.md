# Validation record — RoomRecord 0.3.1
...
| `npm test` | PASS, 4 tests | Exact finalisation count; baseline isolation/comparison; scan rejection atomicity; gyro norm/gap math only |
...
| iPhone launch/camera/stitch/PDF | NOT RUN | Hardware unavailable in this environment |
